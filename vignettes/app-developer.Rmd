...
_Note that `teal.transform` is about to undergo a refactor so the functions in this vignette are subject to change._
...
To construct a `data_extract_spec` object use the `data_extract_spec` function and these helper functions: `select_spec`, `filter_spec`, `variable_choices`, and `value_choices`.
