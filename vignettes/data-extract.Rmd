...
`teal.transform` functions depend on a `FilteredData` object from `teal.slice` package. Normally, `FilteredData` is created 
...
and a second one to select variable from a `c("BMRKR1", "AGE")`. `data_extract_spec` object is handed over to the shiny 
