...
In these situations, the developers need to let the users control the application by giving the users some degree of freedom.
...
A `teal` module can leverage by using the `data_extract_spec` objects and to handle and process the user input.
Examples can be found in the `teal.modules.clinical` package.
