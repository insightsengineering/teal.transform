...
automatically by [teal::init](https://insightsengineering.github.io/teal/reference/init), but for example purposes we define a wrapper function to #no initialize the necessary object. #nolint
