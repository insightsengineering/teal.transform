...
Combining datasets is an essential step when working with modules that involve multiple datasets. Within the context of `teal`, we use the term "merge" to refer to the process of combining datasets. To support this, two functions are provided: `merge_expression_module` and `merge_expression_srv`, each tailored for different use cases.
