...
test_that("Can create variable_choices with datasets with no or missing labels", {
  ...
  teal.widgets::formatters_var_labels(missing_one_label_data) <- c(as.character(NA), "Label")
  ...
  teal.widgets::formatters_var_labels(missing_two_label_data) <- c(as.character(NA), as.character(NA))
