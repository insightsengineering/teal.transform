...
test_that("Delayed data extract - single data connector with two scda dataset connectors", {
  ...
  x_result <- isolate(resolve_delayed(x, datasets = data_list, join_key = key_list))
  y_result <- isolate(resolve_delayed(y, datasets = data_list, join_key = key_list))
...
test_that("Delayed choices selected - single data connector with two scda dataset connectors", {
  ...
  choices_result <- isolate(resolve_delayed(choices, datasets = data_list, join_keys = key_list))
...
test_that("Delayed extract - TealData with single dataset and multiple connectors", {
  ...
  adrs <- teal.data::scda_cdisc_dataset_connector("ADRS", "adrs", keys = teal.data::get_cdisc_keys("ADRS"))
  adtte <- teal.data::scda_cdisc_dataset_connector("ADTTE", "adtte", keys = teal.data::get_cdisc_keys("ADTTE"))
